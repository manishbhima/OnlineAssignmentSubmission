...
<table align="center">
	...
	out.print("<script>alert('Faculty Id already exists')</script>"); 
}
...
<h2>Faculty Register Here</h3></h2>
 <form name="reg" action="factsignup1.jsp" method="get"   name="pwForm" >
			...
			<table align="center" cellpadding="5" cellspacing="5" width="400">
			  <tr> 
                <td><font size="+1"color=#006666><strong>Faculty Id</strong>*</font>
				<br>
				<input type="text" name="factid" style="width: 250px;"	 required>
			</tr>
              <tr> 
